...
public class FreeMarkerUtil {
     ...
     * @param data 数据
     * @param encode 编码
     * @param fullFileName 输出文件路径+文件名
     * @throws Exception
     */
    public static void execute(String templateName, Map data,String encode,String fullFileName) throws Exception{

    	File file =new File(fullFileName);
    	FileOutputStream outputStream =new FileOutputStream(file);
    	execute(CONFIGURATION, templateName,encode, data, outputStream);
